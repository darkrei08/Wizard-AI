...
if command -v node &>/dev/null; then
  ...
  node "$SCRIPT_DIR/scripts/extra-tools-interactive.js" "$EXTRA_TOOLS_FILE"
  if [ -s "$EXTRA_TOOLS_FILE" ]; then
  ...
  rm -f "$EXTRA_TOOLS_FILE"
fi
echo -e "\n${GREEN}╭────────────────────────────────────────────────────────────╮${NC}"
echo -e "${GREEN}│                  🚀 QUICK START GUIDE                      │${NC}"
echo -e "${GREEN}├────────────────────────────────────────────────────────────┤${NC}"
echo -e "${GREEN}│ 1. AI Agents & Cockpit Tools                               │${NC}"
echo -e "${GREEN}│    ${CYAN}wz-ai proxy login${GREEN}        (Add Google Account)         │${NC}"
echo -e "${GREEN}│    ${CYAN}wz-ai proxy setup${GREEN}        (Sync models to Pi)          │${NC}"
echo -e "${GREEN}│    ${CYAN}wizard-ai pi-configurator${GREEN} (Auto-select AI models)     │${NC}"
echo -e "${GREEN}│                                                            │${NC}"
echo -e "${GREEN}│ 2. Scaffolding & Frameworks                                │${NC}"
echo -e "${GREEN}│    ${CYAN}pi 'scaffold a new Qwik app'${GREEN}                          │${NC}"
echo -e "${GREEN}│    ${CYAN}pi 'setup a Nuxt 4 project in ./dashboard'${GREEN}            │${NC}"
echo -e "${GREEN}│    ${CYAN}pi 'bootstrap an Astro 5 landing page'${GREEN}                │${NC}"
echo -e "${GREEN}│                                                            │${NC}"
echo -e "${GREEN}│ 3. Master Initialization                                   │${NC}"
echo -e "${GREEN}│    ${CYAN}pi 'run master-project-bootstrap here'${GREEN}                │${NC}"
echo -e "${GREEN}╰────────────────────────────────────────────────────────────╯${NC}"
echo -e ""
