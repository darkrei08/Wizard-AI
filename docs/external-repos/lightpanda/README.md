# Lightpanda Browser (by lightpanda-io)
...
Requires [Zig](https://ziglang.org/) `0.15.2`, [v8](https://chromium.googlesource.com/v8/v8.git), [Libcurl](https://curl.se/libcurl/) and [html5ever](https://github.com/servo/html5ever). See the [full build guide](https://github.com/lightpanda-io/browser#build-from-sources) for OS-specific prerequisites (`make build`, `make test`, `make end2end`).
