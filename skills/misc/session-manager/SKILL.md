...
description: "SESSION MANAGER — Dual mode skill (Step 1 PRE e Step 10 POST). Ripristina il contesto all'inizio e salva lo stato persistente alla fine. Utilizza MEMORY.md e ai-session-save."
---
...
2. **Invoke the Wrappers**: Esegui **ENTRAMBI** i comandi seguenti (anche in background):
   ...
   ```
   *(Oppure via pipe: `echo "SUMMARY" | ai-session-save`)*
