---
name: easy-vibe
description: "Reference documentation and knowledge base for easy-vibe. Automatically generated from external repository README."
---

# easy-vibe Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `easy-vibe`, `easy-vibe`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for easy-vibe, downloaded from its GitHub repository to serve as your primary source of truth.
