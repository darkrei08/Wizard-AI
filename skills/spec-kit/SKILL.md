---
name: spec-kit
description: "Reference documentation and knowledge base for spec-kit. Automatically generated from external repository README."
---

# spec-kit Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `spec-kit`, `spec-kit`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for spec-kit, downloaded from its GitHub repository to serve as your primary source of truth.
