---
name: personal-graph
description: "Reference documentation and knowledge base for personal-graph. Automatically generated from external repository README."
---

# personal-graph Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `personal-graph`, `personal-graph`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for personal-graph, downloaded from its GitHub repository to serve as your primary source of truth.

---

# personal-graph (by Technoculture)

Source: https://github.com/Technoculture/personal-graph
