---
name: design-hallmark-frontend
description: "Anti-AI-slop design skill for greenfield pages, audits, redesigns, and design extraction from URLs or screenshots. Use when the user asks to create a better design, build a new app or landing page, wants to redesign something, or invokes Hallmark by name."
---
