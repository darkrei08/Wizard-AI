...
4. **MANDATORY DEBUG OPTIMIZATION**: Se lo stack trace o l'analisi superano il **50% della soglia massima di contesto**, innesca `workflow-agentic-brain`, avvia **`headroom`**, esegui un **`mp-handoff`** della diagnosi e applica **`sqz`** e **`caveman`** mode per evitare risposte LLM inutilmente prolisse e overflow (allucinazioni).
