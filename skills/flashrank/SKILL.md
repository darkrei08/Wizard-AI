---
name: flashrank
description: "Reference documentation and knowledge base for FlashRank. Automatically generated from external repository README."
---

# FlashRank Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `FlashRank`, `flashrank`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for FlashRank, downloaded from its GitHub repository to serve as your primary source of truth.
