---
name: syke
description: "Reference documentation and knowledge base for syke. Automatically generated from external repository README."
---

# syke Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `syke`, `syke`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for syke, downloaded from its GitHub repository to serve as your primary source of truth.

---

# syke (by saxenauts)

Source: https://github.com/saxenauts/syke
