---
name: phantom-ui
description: "Reference documentation and knowledge base for phantom-ui. Automatically generated from external repository README."
---

# phantom-ui Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `phantom-ui`, `phantom-ui`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for phantom-ui, downloaded from its GitHub repository to serve as your primary source of truth.

---

# phantom-ui (by Aejkatappaja)

Source: https://github.com/Aejkatappaja/phantom-ui
