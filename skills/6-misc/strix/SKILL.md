...
## Using the ai-strix Wrapper

Strix integrates into the Wizard-AI ecosystem via the `ai-strix` CLI wrapper (or simply `strix`). It leverages AI to act as a hacker and proactively find vulnerabilities in targets (local directories, URLs, or GitHub repos).

### Basic Scans

```bash
# Scan a local codebase
ai-strix --target ./app-directory

# Security review of a GitHub repository
ai-strix --target https://github.com/org/repo

# Black-box web application assessment
ai-strix --target https://your-app.com
```
...
ai-strix --target api.your-app.com --instruction "Focus on business logic flaws and IDOR vulnerabilities"

# White-box source-aware scan
ai-strix --target ./app-directory --scan-mode standard

# Multi-target testing
ai-strix -t https://github.com/org/app -t https://your-app.com

# Headless mode for automated jobs (non-interactive)
ai-strix -n --target https://your-app.com
```
...
- **Environment:** If the user asks for a pentest, run `ai-strix --target <target-directory>`.
