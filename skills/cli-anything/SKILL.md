---
name: cli-anything
description: "Reference documentation and knowledge base for CLI-Anything. Automatically generated from external repository README."
---

# CLI-Anything Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `CLI-Anything`, `cli-anything`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for CLI-Anything, downloaded from its GitHub repository to serve as your primary source of truth.
