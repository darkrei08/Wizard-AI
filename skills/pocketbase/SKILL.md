---
name: pocketbase
description: "Reference documentation and knowledge base for pocketbase. Automatically generated from external repository README."
---

# pocketbase Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `pocketbase`, `pocketbase`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for pocketbase, downloaded from its GitHub repository to serve as your primary source of truth.

---

# pocketbase (by pocketbase)
