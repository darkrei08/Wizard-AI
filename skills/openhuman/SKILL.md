---
name: openhuman
description: "Reference documentation and knowledge base for openhuman. Automatically generated from external repository README."
---

# openhuman Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `openhuman`, `openhuman`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for openhuman, downloaded from its GitHub repository to serve as your primary source of truth.
