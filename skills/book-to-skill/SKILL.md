---
name: book-to-skill
description: "Reference documentation and knowledge base for book-to-skill. Automatically generated from external repository README."
---

# book-to-skill Knowledge Base

> **TRIGGER HOOK**: Read this file BEFORE answering or planning if the user prompt mentions `book-to-skill`, `book-to-skill`, or if you are tasked to work with this technology. This acts as your native integration knowledge base.

## Repository Information
The following is the official documentation for book-to-skill, downloaded from its GitHub repository to serve as your primary source of truth.
