# wz-wz-ai-usage — Track Gemini/AI token usage across sessions
...
if ($args.Count -eq 0) {
    Write-Host 'wz-wz-ai-usage — Track Gemini CLI token usage and session costs'
    Write-Host ''
    Write-Host 'Usage:'
    Write-Host '  wz-wz-ai-usage                   Show current session usage'
    Write-Host '  wz-wz-ai-usage --today           Consumption today'
    Write-Host '  wz-wz-ai-usage --rolling-24h     Last 24 hours'
    Write-Host '  wz-wz-ai-usage --quota           Quota status'
    Write-Host '  wz-wz-ai-usage --history         Full usage history'
    Write-Host ''
