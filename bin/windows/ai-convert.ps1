...
# Windows port of bin/ai-convert
...
if ($args.Count -eq 0) {
    Write-Host 'ai-convert — Convert any file to Markdown for LLM ingestion'
    Write-Host ''
    Write-Host 'Usage:'
    Write-Host '  ai-convert <file>              Convert file to Markdown (stdout)'
    Write-Host '  ai-convert <file> -o out.md    Save to file'
    Write-Host '  ai-convert <url>               Convert URL to Markdown'
    Write-Host '  ai-convert *.pdf               Convert multiple files'
    Write-Host ''
    ...
    Write-Host ''
    Write-Host 'Examples:'
    Write-Host '  ai-convert report.pdf > report.md'
    Write-Host '  ai-convert https://docs.example.com/api'
    Write-Host '  ai-convert presentation.pptx -o slides.md'
    exit 0
}
