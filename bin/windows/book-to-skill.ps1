...
$SkillDir = Join-Path $HOME '.ai-skills\book-to-skill'
...
Write-Host "  uv pip install PyPDF2 pdfminer.six python-docx ebooklib beautifulsoup4 --python `"$HOME\.ai-skills\venv\Scripts\python.exe`""
Write-Host ''
